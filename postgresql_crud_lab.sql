...
INSERT INTO employees (first_name, last_name, middle_name, job_title, department_id, hire_date, salary, manager_id, address_id)
VALUES ('Mira', 'Ilieva', 'V.', 'Software Engineer', 3, '2023-01-01', 75000, 1, 501);
...
WHERE first_name = 'Mira' AND last_name = 'Ilieva';
